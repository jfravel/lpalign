...
\date{Corresponds to \textsf{lpalign} v$1.3$, dated June $26^\textrm{th}$ 2026}
\author{Jamie Fravel}
...
Paragraph \ref{npara1} is a named paragraph.
  \end{verbatim}
\begin{center}$\downarrow$\end{center}\Vskp
...
Currently supported optional keys include
	...
	\item \verb|indent| -- indent distance. The default value of 2em can be changed during package load by the \verb|namedparaindent| option.
...
an equation's sub-tag \lpsubref{nq:1} and \lpsubeqref{nq:2}.
