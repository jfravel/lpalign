...
\begin{tcolorbox}
  ...
  \begin{namedsubeqs}[\itshape\roman]{EQ}
                    ...
                    \begin{subequations}[\scshape\alph]{EQ}
  \end{verbatim}
\begin{center}$\downarrow$\end{center}
\VTrg
\begin{multicols}{2}
...
Also available is \verb|\subref| and \verb|\subeqref| which work like \verb|\ref| and \verb|\eqref| but only reference the secondary, sub-index of the tag. Inside \verb|namedsubeqs|, ordinary \verb|\label| is enough. The \verb|\sublabel| macro remains available.
\begin{tcolorbox}
  \begin{verbatim}
...
or just \subeqref{sq:1} or even \eqref{sq:2}.
\end{tcolorbox}
\verb|\subref| and \verb|\subeqref| work with ordinary \verb|\label| inside \verb|namedsubeqs|. Support for other subequation environments is still separate.
...
\begin{tcolorbox}
  ...
  \end{align}
  \end{subequations}
Testing subrefs with subequations: \verb|\ref{test}| \ref{test}, \verb|\ref{test:1}| \ref{test:1},\verb|\subref{test:1}|\subref{test:1}
\end{tcolorbox}
...
\begin{itemize}
	...
	\item[$\boxdot$] Ordinary \verb|\label| now works again for \verb|\subref| and \verb|\subeqref| inside \verb|namedsubeqs|, but broader support for traditional \textsf{subequations} and other settings remains unresolved after v1.2 testing.
