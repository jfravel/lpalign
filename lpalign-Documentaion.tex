...
an equation's sub-tag \lpsubref{sq:1} and \lpsubeqref{sq:2}.
  \end{verbatim}
\begin{center}$\downarrow$\end{center}
    \begin{subequations}
	  \renewcommand{\theequation}
    ...
    \end{align}
    \end{subequations}
We can also reference \ref{sq:1} and \eqref{sq:2}, or sub-reference \lpsubref{sq:1} and \lpsubeqref{sq:2} in a \textsf{subequations} environment.
\end{tcolorbox}
