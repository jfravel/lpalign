...
If loaded, \textsf{cleverref} uses the \verb|cref| key to 
...
If loaded, \textsf{cleverref} uses the \verb|cref| key to reference \cref{sat}. This example assumes that the \verb|Problem| category has been defined in the preamble with with \verb|\crefname{Problem}{Problem}{Problems}|.
\end{tcolorbox}
