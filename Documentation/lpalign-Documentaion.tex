...
or just \subeqref{sq:1} or even \eqref{sq:2}.
\end{tcolorbox}
The \verb|\sublabel| macro is designed around the \verb|namedsubeqs| environment; it will not work properly in a traditional \verb|subequations| environment. Users should probably only use \verb|\sublabel| on equations they actually intend to \verb|\subref|.
...
\begin{itemize}
	...
	\item[$\boxtimes$] When \textsf{hyperref} was loaded, \verb|\sublabel| could produce duplicate equation destinations or occasionally link to the wrong tag. Fixed by assigning a dedicated hyperref-facing equation identifier inside \textsf{namedsubeqs}; test branch after v1.2.
