...
\begin{lpregionbox}[flush=l]
  \mathcal{P} = \left\{
  \begin{lpregionbox}[flush=l]
    A\mathbf{x} &\le \mathbf{b} \label{box:1} \\
    \mathbf{x}  &\ge 0          \label{box:2}
  \end{lpregionbox}
  \right.
\end{lpregionbox}
\]

Nested box labels should remain referenceable: \eqref{box:1}, \eqref{box:2}.
...
\begin{lpalign}[row-sep=-0.2em]{Maximize}
  {c_1x_1+c_2x_2+c_3x_3+c_4x_4+c_5x_5+c_6x_6+c_7x_7+c_8x_8+c_9x_9
   \span\downtag}
